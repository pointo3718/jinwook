...
<body>
    ...
    <section class="blog-details-hero set-bg" data-setbg="${path}/resources/static/img/blog/details/details-hero.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
              ...
              <div class="col-lg-8 col-md-7 order-md-1 order-1" style="border: 5px solid green;">
                <form name="readForm" role="form" method="post">
                    ...
                    <div class="row">
	  					<div class="col-xs-5 col-md-3" style="font-size:15px">No. ${recipe.rcpNo}</div>
					</div><br/>
                    <div class="container">
  ...
  <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/>
                    ...
                    <div class="container-fluid">
	  					<div class="col-xs-5 col-xl-5" style="font-size:15px; text-align:right; float:right;">
                    작성자: ${user.userId}<!-- 관리자로 바뀌어야 함 -->
					</div>
					</div><br/><br/>
                        <%-- <img src="${path}/resources/static/img/blog/details/details-pic.jpg" alt=""> --%>
                    <div class="container">
	  					<div class="col-xl-7 col-xl-5" style="width:1000px;height:500px;font-size:18px;border: 10px solid green;">${recipe.rcpContent}
	  				</div>
					</div><br/><br/>
