...
<body>
	...
	<div class="container">
		...
		<!-- form Start /////////////////////////////////////-->
		<form action="board/updateRecipe" method="post" class="form-horizontal">

			<div class="form-group">
				<label for="rcpNo" class="col-sm-offset-1 col-sm-3 control-label">레시피 번호</label>
				<div class="col-sm-4">
