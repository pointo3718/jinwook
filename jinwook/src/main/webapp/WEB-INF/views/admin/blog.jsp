...
<script type="text/javascript">
	...
	function countAdRequest() {
		...
		$.get(uri, function(response) {
				...
				countAdHtml += `
						광고 요청 <span class="badge badge-danger">\${response.CountRequestWaiting}</span>
					`;
		...
		<div class="container">
			<div class="row" style="justify-content: space-around;">
						...
						<div class="blog__sidebar__item">
							...
							<div class="list-group text-center" style="font-size: 15px;">
								...
								<button type="button"
									...
									목록</button>
								<button type="button"
									class="list-group-item list-group-item-action"><span class="addStore">상점 등록
									요청</span>
									 </button>
								<button type="button"
									class="list-group-item list-group-item-action"><span class="deleteStore">상점 삭제
									요청</span></button>
								<button type="button"
									class="list-group-item list-group-item-action"><span class="refundStore">환급 
									요청</span></button>
								<button type="button"
									class="list-group-item list-group-item-action"><span class="adStore">광고 등록
									요청</span></button>
								<button type="button"
									class="list-group-item list-group-item-action">문의 내역</button>
							</div>
				...
				<div>
					<h4 class="text-left">
						<strong>회원 목록</strong>
						<p class="text-muted" style="display: inline; font-size: 12px;">회원
							조회가 가능합니다</p>
						<div class="btn-group btn-group-toggle" data-toggle="buttons" style="left:300px;">
							<label class="btn btn-light active" style="font-size: 13px;"> <input
								type="radio" name="options" id="option1" checked> &nbsp; &nbsp; &nbsp;  회원 &nbsp; &nbsp; &nbsp;    
							</label> <label class="btn btn-light" style="font-size: 13px;" > <input type="radio"
								name="options" id="option3"> 블랙리스트
							</label>
						</div>
						<hr size="10px">
					</h4>
