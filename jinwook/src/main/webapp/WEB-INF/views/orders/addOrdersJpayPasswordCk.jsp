...
#modal1>#content1 .title {
	text-align: center;
}

#modal1>#content1 .pwWrap .pwSection{
  position: relative;
  display: flex;
...
#modal1>#content1 .pwWrap .pwSection .dot {
  display: block;
  width: 10px;
  height: 10px;
  background: darkgrey;
...
#modal1>#content1 .pwWrap .pwSection .dot.active {
  background: rgba(0, 0, 0, 0.7);
}

#modal1>#content1 .pwWrap .pwSection .message {
  position: absolute;
  bottom: 5px;
  left: 0;
  z-index: 1;
...
#modal1>#content1 .pwWrap .numberSection {
  overflow: hidden;
}

#modal1>#content1 .pwWrap .numberSection .number {
  float: left;
  width: 33.33%;
  height: 60px;
...
#modal1>#content1 .pwWrap .numberSection .number:last-child {
  margin-left: 0%;
...
<input type='button' value='addCkopen' id='btnOpen1'>
<div id='modal1'>
	<div id='content1'>
...
<script>
var btnOpen  = document.getElementById('btnOpen1');
