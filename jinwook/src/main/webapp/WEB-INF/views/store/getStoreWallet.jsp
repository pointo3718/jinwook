...
<body>
   ...
   <div class="modal fade" id="modalForRefund" tabindex="-1"
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <form id="detailForm" name="detailForm" method="post">
                  ...
                  <div class="container">
                     <div>
                        <i class="fa fa-check" aria-hidden="true"></i> &nbsp;환급하실 금액을
                        숫자로만 입력해주세요.
                     </div>
                     <div>
                        <i class="fa fa-check" aria-hidden="true"></i> &nbsp;문의사항은
                        1:1문의/고객센터(1644-0000)로 문의 바랍니다.
                     </div>
                  </div>
                  <hr>
                  ...
                  <div class="form-group row">
                     <label for="colFormLabelLg"
                        class="col-sm-3 col-form-label col-form-label"><strong>환급
                           금액</strong></label>
                     <div class="col-sm-7">
                        <input class="form-control form-control" type="text"
                           id="refundMoney" name="refundMoney"
                           placeholder="환급하실 금액을 입력해주세요." />


                     </div>
                     <div class="col-sm-1"
                        style="padding-left: 0px; top: 8px; right: 10px;">원</div>
                  </div>
               </form>
   ...
   <section class="blog spad">
      <div class="container">
         <div class="row" style="justify-content: space-around;">
            ...
            <!-- 지갑 조회 start-->
            <div style="margin-bottom: 1150px; width: 850px;" class="wallet">
               <h4 class="text-left">
               ...
               <table class="table table-borderless">
                  ...
                  <tbody>
                           ...
                           <c:forEach var="store" items="${storeInfo}" begin="0"
                        end="0">
                        <tr>
                           <th scope="row">진욱페이 잔액</th>
                           <td>${store.user.jpBalance}원</td>
                           <td><button type="button"
                                 class="btn btn-outline-success btn-sm" id="refund"
                                 data-toggle="modal" data-target="#modalForRefund">환급신청</button></td>
                        </tr>
                     </c:forEach>
               ...
               <h6 class="text-left">
                  ...
                  <strong style="padding-left: 10px;">기간별 주문내역</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                     style="color: #6E6E6E; font-size: 13px"> <c:if
                        test="${store.orderDateStart==null}">
                     오늘의 주문내역입니다.
                     </c:if> <c:if test="${store.orderDateStart!=null}">               
                     ${store.orderDateStart}~${store.orderDateEnd}</c:if></span>
               </h6>
