...
<script type="text/javascript">
   ...
   function fncUpdateStoreProduct(PRODNO, PRICE, PRODINFO,PRODORIGN,PRODIMG) {
         
         alert(PRODNO+PRODINFO+PRICE+PRODORIGN,PRODIMG);
        var url = "updateStoreProduct/" + PRODNO+"/"+PRICE+"/"+PRODORIGN+"/"+PRODINFO+"/"+PRODIMG
											...
											<div class="col-lg-8 col-md-6">
												<c:forEach var="store" items="${store}">
													<div class="row" style="width: 900px;">
														...
														<div class="col-lg-2">
															<div class="checkout__input price">
																<p></p>
														...
														<div class="col-lg-2">
															<div class="checkout__input info">
																<p></p>
																<input type="text" value="${store.product.prodInfo}"
																	data-prodno="${store.product.prodNo}"
														...
														<div class="col-lg-2">
															<div class="checkout__input img">
																<p></p>
																<input type="text" data-value="${store.product.prodImg}"
																	id="prodImg" placeholder="${store.product.prodImg}"
																	style="color: #595959;">
															</div>
														</div>
														<div class="col-lg-2">
															<div class="checkout__input orign">
																<p></p>
														...
														<button type="button" name="buttons"
															...
															onClick="fncUpdateStoreProduct(${store.product.prodNo},
                                             ${store.product.price},'${store.product.prodInfo}',
                                             '${store.product.prodOrign}','${store.product.prodImg}');">수정</button>
														&nbsp;&nbsp;&nbsp;
