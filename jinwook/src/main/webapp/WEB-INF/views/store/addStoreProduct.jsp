...
<script type="text/javascript">
   ...
   $(function() {
      $(soldout).on("click", function fncIsSoldout() {
         ...
         var btnElement = document.getElementById('soldout');
         var soldout = false
   ...
   $(function() {
      $(sell).on("click", function fncIsSoldout() {

         var STORENO = $("input[name='storeNo']").val();
         var btnElement = document.getElementById('sell');
         var soldout = true

         console.log(soldout);
         var prodNo = $("#sell").parent().parent().parent().parent().parent().find("#prodNo").val()
                                 ...
                                 <c:forEach var="store" items="${store}">
                                    ...
                                    <tr>
                                       ...
                                       <div><input
                                             ...
                                             value="${store.product.prodNo}"></div>
                                       ...
                                       <td class="shoping__cart__price">
                                          <button type="button" id="sell" name="sell"
                                             ...
                                             class="btn btn-success btn-sm sell">판매</button>
                                          <button type="button" id="soldout" name="soldout"
                                             data-value="${store.product.prodNo}"
                                             class="btn btn-danger btn-sm soldout">매진</button>
