...
<script type="text/javascript">
	...
	function fncUpdateStoreProduct(e) {
		...
		var a = $(e).parents("div").children("div").closest("input").find("input[class='price']");

		console.log(a)
		var STORENO = $("input[id='storeNo']").val();
		var prodNo = $(e).data("value");

		var PRICE = $(e).parents("input[data-n='\${prodNo}']");
												...
												<div class="col-lg-2">
													<div class="checkout__input">
														...
														<input class="price" type="text"
															data-n="${store.product.prodNo}"
															value="${store.product.price}" id="price"
